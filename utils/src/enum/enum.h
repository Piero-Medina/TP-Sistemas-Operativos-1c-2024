...
typedef enum{
    SALIDA_SUCCESS,
    SALIDA_INVALID_RESOURCE,
    SALIDA_SEGMENTATION_FAULT,
    SALIDA_OUT_OF_MEMORY,
    SALIDA_INVALID_INTERFACE,
    SALIDA_INVALID_INTERFACE_OPERATION,
    SALIDA_INTERRUPTED_BY_USER          //FINALIZADO POR CONSOLA INTERACTIVA
}motivo_exit;
